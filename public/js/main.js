...
var prLover = {
  ...
  templateNote: function(noteData) {
    ...
    var newNote = "<li class='note "+visitorClass+" col-md-3'><div class='note-main'>" + noteData.text;
    if(noteData.isVisitor){
        newNote += "<div class='note-isvisitor'><i class='fa fa-send' title='This note is from a visitor' alt='This message is from a visitor'></i></div>";
    }
    newNote += "</div>";
    ...
    newNote = newNote + '<div class="tweet-link pull-right"><a href="' + tweetUrl + '"><i class="fa fa-twitter"/></a></div>';
    newNote = newNote + '</li>';
